        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('pengurus.kelola-pengurus.update', $pengurus) }}">
                        @csrf
                        @method('PUT')

                        <div>
                            <label for="nama" class="block font-medium text-sm text-gray-700">Nama</label>
                            <input id="nama" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" type="text" name="nama" value="{{ old('nama', $pengurus->nama) }}" required autofocus />
                        </div>
                        <div class="mt-4">
                            <label for="username" class="block font-medium text-sm text-gray-700">Username</label>
                            <input id="username" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" type="text" name="username" value="{{ old('username', $pengurus->username) }}" required />
                        </div>
                        <div class="mt-4">
                            ...
                            <input id="no_hp" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" type="text" name="no_hp" value="{{ old('no_hp', $pengurus->no_hp) }}" placeholder="Contoh: 08123456789" />
                        </div>
                        <div class="mt-4">
