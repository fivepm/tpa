        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                    <form method="POST" action="{{ route('pengurus.kelola-materi.store') }}">
                        @csrf
                        <div>
                            <label for="nama_materi" class="block font-medium text-sm text-gray-700">Nama Materi</label>
                            <input id="nama_materi" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" type="text" name="nama_materi" value="{{ old('nama_materi') }}" required autofocus />
                        </div>
